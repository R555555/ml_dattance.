...
# obj = sio.dumps(clf)
# pickle.dumb(open('Modal.pki', 'wb'))
filename = 'diabetes-prediction-rfc-model.pkl'
model = pickle.load(open('/Users/shashikantmanjhi/Rahul Assets/dattans 2023 RiskAssess-master/model.pkl', 'rb'))
model1 = pickle.load(open('/Users/shashikantmanjhi/Rahul Assets/dattans 2023 RiskAssess-master/model1.pkl', 'rb'))
...
@app.route('/')
def index():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\index.html")


@app.route('/about')
def about():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\about.html")


@app.route('/help')
def help():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\help.html")


@app.route('/terms')
def terms():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\tc.html")
...
@login_required
def dashboard():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\dashboard.html")


@app.route("/disindex")
def disindex():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\disindex.html")


@app.route("/cancer")
@login_required
def cancer():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\cancer.html")


@app.route("/diabetes")
@login_required
def diabetes():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\diabetes.html")


@app.route("/heart")
@login_required
def heart():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\heart.html")


@app.route("/kidney")
@login_required
def kidney():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\kidney.html")


def ValuePredictor(to_predict_list, size):
    to_predict = np.array(to_predict_list).reshape(1, size)
    if size == 7:
        loaded_model = joblib.load('F:\dattans 2023 RiskAssess-master\kidney_model.pkl')
...
def predictkidney():
    ...
    return render_template("F:\dattans 2023 RiskAssess-master\templates\kidney_result.html", prediction_text=prediction)


@app.route("/liver")
@login_required
def liver():
    return render_template("F:\dattans 2023 RiskAssess-master\templates\liver.html")


def ValuePred(to_predict_list, size):
    to_predict = np.array(to_predict_list).reshape(1, size)
    if (size == 7):
        loaded_model = joblib.load('F:\dattans 2023 RiskAssess-master\liver_model.pkl')
        result = loaded_model.predict(to_predict)
    return result[0]
